Gem::Specification.new do |s|
    ...
    s.files       = ['lib/ruby_memcached.rb', 'lib/ruby_memcached/Memcached.rb', 'lib/ruby_memcached/Item.rb', 'lib/ruby_memcached/Responses.rb', 'lib/ruby_memcached/server/Server.rb', 'lib/ruby_memcached/server/constants/Commands.rb', 'lib/ruby_memcached/server/constants/Errors.rb', 'lib/ruby_memcached/server/constants/Responses.rb' ]
